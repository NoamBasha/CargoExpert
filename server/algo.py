...
def constructive_packing(boxes: list[Box], container: Container, is_quantity: int) -> list[Box]:
    ...
    solution_data['overall_score'] = overall_metric(boxes, container, solution_data, is_quantity)
...
def algo():
    ...
    solution_list = get_solutions(NUMBER_OF_ITERATIONS, boxes, container, is_quantity)
